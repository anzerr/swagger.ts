...
export declare const responses: (status: number, desc: string, content?: any) => any;
...
export declare const param: {
    query: (name: string, desc?: string, example?: string | number, option?: any) => (target: any, propertyKey: string, descriptor: PropertyDescriptor) => PropertyDescriptor;
    ...
    path: (name: string, desc?: string, example?: string | number, option?: any) => (target: any, propertyKey: string, descriptor: PropertyDescriptor) => PropertyDescriptor;
};
