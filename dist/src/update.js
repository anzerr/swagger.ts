...
const run = (cmd, o) => {
    return new Promise((resolve) => {
        const ls = (0, child_process_1.spawn)('sh', ['-c', cmd], o);
...
Promise.all([
    (0, fs_remove_1.default)(dir),
    (0, fs_remove_1.default)(path.join(__dirname, `../${key}`))
]).then(() => {
    ...
    return Promise.all([
        (0, fs_remove_1.default)(path.join(__dirname, `../${key}`)),
        (0, fs_remove_1.default)(path.join(dir, 'index.html')),
        (0, fs_remove_1.default)(path.join(dir, 'oauth2-redirect.html'))
    ]);
}).catch((e) => {
    throw e;
});
